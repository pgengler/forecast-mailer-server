...
class SubscriptionsControllerTest < ActionController::TestCase
	...
	test "redirects to index after creating a new subscription" do
		post :create, params: { subscription: { location: 'Over there', email: 'example@example.com' } }
		assert_response :redirect
		assert_redirected_to subscriptions_path
	end

	test "displays a message after creating a new subscription" do
		post :create, params: { subscription: { location: 'Over there', email: 'dummy@example.com' } }
		assert_equal 'Subscription created', flash[:success]
	end

	test "shows an 'edit' form" do
		get :edit, params: { id: subscriptions(:no_dates) }
		assert_response :success
		assert_select 'form'
	end

	test "can update values for a subscription" do
		put :update, params: { id: subscriptions(:no_dates), subscription: { email: 'nobody@example.com', location: 'The Middle of Somewhere', start: '2014-01-01', end: '2014-02-01' } }
	...
	test "redirects to the index page after updating a subscription" do
		put :update, params: { id: subscriptions(:no_dates), subscription: { email: 'bill@example.com' } }
		assert_response :redirect
		assert_redirected_to subscriptions_path
	end

	test "displays a message after updating a subscription" do
		put :update, params: { id: subscriptions(:no_dates), subscription: { start: '2014-01-01' } }
		assert_equal 'Subscription updated', flash[:success]
	end

	test "can delete a subscription" do
		assert_difference 'Subscription.count', -1 do
			delete :destroy, params: { id: subscriptions(:no_dates) }
		end
	end
